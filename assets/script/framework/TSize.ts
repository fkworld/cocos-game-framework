...
export class TSize extends cc.Component {
    ...
    private change_size_by_width() {
        this.current_size.y = FTool.get_number_fixed(this.current_size.x / this.source_size.x * this.source_size.y)
    ...
    private change_size_by_height() {
        this.current_size.x = FTool.get_number_fixed(this.current_size.y * this.source_size.x / this.source_size.y)
        this.node.width = this.current_size.x
        this.node.height = this.current_size.y
    }
